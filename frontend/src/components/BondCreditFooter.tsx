// src/components/BondCreditFooter.tsx
import React from 'react';

const BondCreditFooter: React.FC = () => {
        ...
        <div className="ft">
          <div>
            ...
            <div className="ft-copy">
              Agentic Alpha · Agentic Credit Intelligence · 2025
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="BondCredit on GitHub"
              className="social-link"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default BondCreditFooter;
