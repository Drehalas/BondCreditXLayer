...
import { dateOnlyFromUnixSec, daysFromDuration, formatWeiAmount, getSubscriptionReadContract, getSubscriptionWriteContract, hasSubscriptionContract, resolveAgentAddress } from '../onchain.js';
export class SubscriptionClient {
     ...
     */
    async subscribe(input = { duration: '30 days', autoRenew: true }) {
